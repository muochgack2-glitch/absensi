    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah", "nama", "kelas", "hari_tanggal", "waktu", "footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah", "nama", "kelas", "hari_tanggal", "waktu", "terlambat", "footer"]),
                "usage_count" => 0,
            ],
            // ── 3. Check-in: Izin ─────────────────────────────────────
            [
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah", "nama", "kelas", "hari_tanggal", "waktu", "jam_resmi", "footer"]),
                "usage_count" => 0,
            ],
            // ── 6. Tidak Hadir: Alpha ─────────────────────────────────
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah", "nama", "kelas", "hari_tanggal", "tanggal", "footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah", "nama", "kelas", "hari_tanggal", "waktu", "terlambat", "toleransi", "jam_resmi_masuk", "footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah","nama","kelas","tanggal_absensi","tanggal_koreksi","status_lama","status_baru","waktu_masuk","keterangan","footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah","nama","kelas","hari_tanggal","tanggal_koreksi","status_lama","status_baru","keterangan","footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah","nama","kelas","hari_tanggal","waktu","keterangan","footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah","nama","kelas","hari_tanggal","waktu","terlambat","toleransi","jam_resmi_masuk","keterangan","footer"]),
                "usage_count" => 0,
            ],
            ...
            [
                ...
                "is_active"   => true,
                "auto_send"   => true,
                "variables"   => json_encode(["sekolah","nama","kelas","hari_tanggal","keterangan","footer"]),
                "usage_count" => 0,
            ],
