...
class XAKLSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $waliKelas = User::firstOrCreate(
            ['email' => 'dhani.kisworo@smkn1.sch.id'],
            [
        ...
        // 3. Create Students
        $students = [
            ['nis' => '2024', 'nama' => 'AHMAD BAGUS NUR HIDAYAT'],
            ['nis' => '2025', 'nama' => 'AYUNDA VIVI ANDILLA'],
            ['nis' => '2026', 'nama' => 'DWI YANTI WAHYUNINGRUM'],
            ['nis' => '2027', 'nama' => 'LELY AYU NOVITASARI'],
            ['nis' => '2028', 'nama' => 'LINDA CAHAYA'],
            ['nis' => '2029', 'nama' => 'MEYLANI PUTRI PUSPITASARI'],
            ['nis' => '2030', 'nama' => 'NABILA UFAIRA'],
            ['nis' => '2031', 'nama' => 'NARA ILMALIS SAFALA BIBAH'],
            ['nis' => '2032', 'nama' => 'NEYSA AYUNNGRUM'],
            ['nis' => '2033', 'nama' => 'NOVI AMBARWATI'],
