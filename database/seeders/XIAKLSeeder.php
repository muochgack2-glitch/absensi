...
class XIAKLSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        $waliKelas = User::firstOrCreate(
            ['email' => 'adela.wulan@smkn1.sch.id'],
            [
        ...
        // 3. Create Students
        $students = [
            ['nis' => '2003', 'nama' => 'ARESTA LIAN CANTIKA'],
            ['nis' => '2004', 'nama' => 'ASHILA MAYDISTI PRAMESWARI'],
            ['nis' => '2005', 'nama' => 'LUTFIA NUR AINI'],
            ['nis' => '2006', 'nama' => 'NAZWA PERMATA OKTAVIA'],
            ['nis' => '2007', 'nama' => 'RIZKIYA NURUL SABRINA'],
        ];
        $nomorHP = '0882006582245'; // No HP Ortu XI AKL
