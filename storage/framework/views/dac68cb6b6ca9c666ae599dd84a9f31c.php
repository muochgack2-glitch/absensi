...
<?php $component->withAttributes([]); ?>
    ...
    <div class="text-center mb-6">
        <?php if(isset($appLogoUrl) && $appLogoUrl): ?>
            <img src="<?php echo e($appLogoUrl); ?>" alt="Logo" class="w-16 h-16 mx-auto rounded-xl object-contain mb-3">
        <?php else: ?>
        ...
        <?php endif; ?>
        <h2 class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($appSchoolName ?? 'Absensi QR'); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\SPMB\absensi\resources\views/auth/login.blade.php ENDPATH**/ ?>