                ...
                <table class="w-full text-xs text-left">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-800/50 <?php echo e($bgRow); ?>">
                            ...
                            <td class="px-3 py-2 text-gray-600 dark:text-gray-400 font-mono hidden sm:table-cell"><?php echo e($row['nis']); ?></td>
                            <td class="px-3 py-2 font-medium text-gray-900 dark:text-white"><?php echo e($row['nama']); ?></td>
                            <td class="px-3 py-2 text-gray-600 dark:text-gray-400 hidden md:table-cell"><?php echo e($row['kelas']); ?></td>
