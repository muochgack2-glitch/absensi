...
<?php $component->withAttributes([]); ?>
                            <div class="flex items-center space-x-2">
                                ...
                                <?php if($student->qr_code_path): ?>
                                    <a 
                                        href="<?php echo e(route('attendance.qr.download-card-pdf', $student->nis)); ?>" 
            ...
            <div class="flex gap-2">
                ...
                <div class="mb-5">
                    ...
                    >
                        ...
                        <?php $__currentLoopData = \App\Models\AttendanceClass::orderBy('nama_kelas')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kelas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kelas->id); ?>">
                                <?php echo e($kelas->nama_kelas); ?> (<?php echo e($kelas->students()->where('is_active', true)->count()); ?> siswa)
                            </option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
