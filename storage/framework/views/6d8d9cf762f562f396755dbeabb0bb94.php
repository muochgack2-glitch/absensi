...
<?php $component->withAttributes([]); ?>
    ...
    <div class="result-wrap">
        ...
        <a href="<?php echo e(route('portal.index')); ?>" class="btn-back">
        ...
        <div class="student-card mb-4">
            <div style="position:relative;z-index:1">
                ...
                <h2 class="text-2xl font-bold text-white leading-tight"><?php echo e($student->nama); ?></h2>
                <div class="flex flex-wrap gap-4 mt-3 text-sm">
                    <span class="text-purple-200"><i class="fas fa-id-card mr-1"></i>NIS: <?php echo e($student->nis); ?></span>
                    <span class="text-purple-200"><i class="fas fa-chalkboard mr-1"></i><?php echo e($student->kelas->nama_kelas ?? '-'); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="stats-grid">
            <div class="stat-box">
                <div class="val" style="color:#22c55e"><?php echo e($summary['hadir']); ?></div>
                <div class="lbl">Hadir</div>
            </div>
            <div class="stat-box">
                <div class="val" style="color:#f59e0b"><?php echo e($summary['terlambat']); ?></div>
                <div class="lbl">Terlambat</div>
            </div>
            <div class="stat-box">
                <div class="val" style="color:#3b82f6"><?php echo e($summary['izin']); ?></div>
                <div class="lbl">Izin</div>
            </div>
            <div class="stat-box">
                <div class="val" style="color:#a855f7"><?php echo e($summary['sakit']); ?></div>
                <div class="lbl">Sakit</div>
            </div>
            <div class="stat-box">
                <div class="val" style="color:#ef4444"><?php echo e($summary['alpha']); ?></div>
        ...
        <div class="progress-wrap">
            <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-lg font-bold <?php echo e($persen >= 75 ? 'text-green-600' : ($persen >= 50 ? 'text-yellow-600' : 'text-red-600')); ?>">
                    <?php echo e($persen); ?>%
                </span>
            </div>
            <div class="progress-bar">
                <div class="progress-fill" id="progressFill"
                     style="width:0%;background:<?php echo e($persen >= 75 ? '#22c55e' : ($persen >= 50 ? '#f59e0b' : '#ef4444')); ?>">
                </div>
            </div>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                <?php echo e($summary['hadir'] + $summary['terlambat']); ?> dari <?php echo e($totalHari); ?> hari sekolah
                &nbsp;
                <?php if($persen >= 75): ?>
        ...
        <div class="month-filter">
            ...
            <form method="GET" action="<?php echo e(route('portal.result')); ?>">
                <input type="hidden" name="nis" value="<?php echo e($student->nis); ?>">
                <select name="bulan" class="month-select" onchange="this.form.submit()">
                    <?php $__currentLoopData = $bulanList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($bl['value']); ?>" <?php echo e($bulan === $bl['value'] ? 'selected' : ''); ?>>
                            <?php echo e($bl['label']); ?>
        ...
        <div class="records-card">
            <div class="rec-header">
                ...
                <span class="text-xs text-gray-500 dark:text-gray-400">
                    <?php echo e(\Carbon\Carbon::parse($startDate)->translatedFormat('d M')); ?> –
                    <?php echo e(\Carbon\Carbon::parse($endDate)->translatedFormat('d M Y')); ?>
            ...
            ?>
            <div class="rec-row">
                <div class="status-dot dot-<?php echo e($st); ?>"></div>
                <div class="flex-1">
                    <div class="text-sm font-semibold text-gray-800 dark:text-white">
                        <?php echo e(\Carbon\Carbon::parse($rec->date)->translatedFormat('l, d F Y')); ?>

                    </div>
                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        <?php if($rec->check_in_time): ?>
                            <i class="fas fa-sign-in-alt text-green-500 mr-1"></i>Masuk: <?php echo e(\Carbon\Carbon::parse($rec->check_in_time)->format('H:i')); ?>

                        <?php endif; ?>
                        <?php if($rec->check_out_time): ?>
                            &nbsp;<i class="fas fa-sign-out-alt text-blue-500 ml-2 mr-1"></i>Keluar: <?php echo e(\Carbon\Carbon::parse($rec->check_out_time)->format('H:i')); ?>

                        <?php endif; ?>
                        <?php if(!$rec->check_in_time && !$rec->check_out_time): ?>
                            <span class="text-gray-400">Tidak ada catatan waktu</span>
                        <?php endif; ?>
                    </div>
                </div>
                <span class="badge-status bg-<?php echo e($st); ?>"><?php echo e($labels[$st] ?? $st); ?></span>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (fill) {
                setTimeout(() => { fill.style.width = '<?php echo e($persen); ?>%'; }, 200);
            }
        });
    </script>
    <?php $__env->stopPush(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\SPMB\absensi\resources\views/attendance/portal/result.blade.php ENDPATH**/ ?>