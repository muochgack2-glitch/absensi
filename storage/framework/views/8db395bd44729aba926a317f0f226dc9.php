        ...
        <div class="form-card">
            ...
            <div class="form-header">
                <div class="flex items-center gap-3">
                    <?php if(isset($appLogoUrl) && $appLogoUrl): ?>
                        <img src="<?php echo e($appLogoUrl); ?>" alt="Logo" class="w-12 h-12 rounded-xl object-contain bg-white/20 p-1">
                    <?php else: ?>
                    ...
                    <div>
                        ...
                        <p class="text-green-100 text-sm mt-0.5"><?php echo e($schoolName); ?></p>
                    </div>
                </div>
            ...
            <div class="form-body">
                <form method="POST" action="<?php echo e(route('izin.submit')); ?>" enctype="multipart/form-data" id="izinForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-5">
                        <div>
                            ...
                            <input type="date" name="tanggal_mulai" id="tanggalMulai"
                                   ...
                                   value="<?php echo e(old('tanggal_mulai', date('Y-m-d'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_selesai" id="tanggalSelesai"
                                   min="<?php echo e(date('Y-m-d')); ?>"
                                   value="<?php echo e(old('tanggal_selesai', date('Y-m-d'))); ?>"
                                   class="field-input">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="alasan" id="alasan" rows="3"
                                  ...
                                  class="field-input field-textarea"><?php echo e(old('alasan')); ?></textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                        <div>
                            ...
                            <input type="text" name="nama_pelapor" id="namaPelapor"
                                   value="<?php echo e(old('nama_pelapor')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="tel" name="no_hp_pelapor" id="noHp"
                                   value="<?php echo e(old('no_hp_pelapor')); ?>"
                                   placeholder="08XXXXXXXXXX"
                                   class="field-input">
                            <?php $__errorArgs = ['no_hp_pelapor'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p><?php unset($message);
    ...
    <script>
        ...
        input.addEventListener('input', () => {
            ...
            searchTimeout = setTimeout(async () => {
                try {
                    const resp = await fetch(`<?php echo e(route('izin.search')); ?>?query=${encodeURIComponent(q)}`, {
...
<?php endif; ?>
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\SPMB\absensi\resources\views/attendance/izin/public-form.blade.php ENDPATH**/ ?>