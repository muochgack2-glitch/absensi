        ...
        <div class="portal-card">
            <?php if(isset($appLogoUrl) && $appLogoUrl): ?>
                <div class="icon-ring" style="background: white; box-shadow: 0 8px 24px rgba(0,0,0,0.12);">
                    <img src="<?php echo e($appLogoUrl); ?>" alt="Logo" style="width: 48px; height: 48px; object-fit: contain;">
                </div>
            <?php else: ?>
                <div class="icon-ring">
            ...
            <?php if($errors->has('query')): ?>
                <div class="flex items-center gap-2 px-4 py-3 mb-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl text-sm text-red-700 dark:text-red-400">
                    ...
                    <span><?php echo e($errors->first('query')); ?></span>
                </div>
            <?php endif; ?>

            <form method="POST" action="<?php echo e(route('portal.check')); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DMCenter\Music\SPMB2\SPMB\absensi\resources\views/attendance/portal/index.blade.php ENDPATH**/ ?>