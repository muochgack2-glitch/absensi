<x-app-layout>
                ...
                <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" 
                                       ...
                                       value="1"
                                       {{ old('settings.include_photo_in_notification', \App\Models\AttendanceSetting::get('include_photo_in_notification', '1', 'notification')) == '1' ? 'checked' : '' }}
                                       class="sr-only peer">
                                <div class="w-11 h-6 bg-gray-300 dark:bg-gray-600 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary-600"></div>
                            </label>
                        </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="number"
                                   name="settings[wa_broadcast_delay]"
                                   id="wa_broadcast_delay"
                                   min="1" max="30" step="1"
                                   value="{{ old('settings.wa_broadcast_delay', \App\Models\WhatsAppSetting::get('wa_broadcast_delay', 2)) }}"
                                   class="w-24 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-center font-mono text-lg">
                            <span class="text-sm text-gray-600 dark:text-gray-400">detik</span>
                            <div class="flex gap-2 ml-2">
                                <button type="button" onclick="setDelay(2)" class="px-3 py-1.5 text-xs rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Normal (2s)</button>
                                <button type="button" onclick="setDelay(5)" class="px-3 py-1.5 text-xs rounded-lg border border-orange-300 dark:border-orange-700 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors">Aman (5s)</button>
                                <button type="button" onclick="setDelay(10)" class="px-3 py-1.5 text-xs rounded-lg border border-red-300 dark:border-red-700 text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">Lambat (10s)</button>
                            </div>
                        </div>
                        <p class="text-xs text-orange-600 dark:text-orange-400 mt-2">
                            ⚠️ Akun WA personal biasanya dibatasi ~200 pesan/hari. Untuk volume tinggi, gunakan WhatsApp Business API.
                        </p>
                    </div>
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-800 rounded-lg">
                        ...
                        <div class="flex items-center gap-3">
                            <input type="number"
                                   name="settings[wa_queue_delay_per_message]"
                                   id="wa_queue_delay_per_message"
                                   min="1" max="30" step="1"
                                   value="{{ old('settings.wa_queue_delay_per_message', \App\Models\WhatsAppSetting::get('wa_queue_delay_per_message', 4)) }}"
                                   class="w-24 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-primary-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-center font-mono text-lg">
                            <span class="text-sm text-gray-600 dark:text-gray-400">detik/pesan</span>
                            <div class="flex gap-2 ml-2">
                                <button type="button" onclick="document.getElementById('wa_queue_delay_per_message').value=2" class="px-3 py-1.5 text-xs rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">Cepat (2s)</button>
                                <button type="button" onclick="document.getElementById('wa_queue_delay_per_message').value=4" class="px-3 py-1.5 text-xs rounded-lg border border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors">Normal (4s)</button>
                                <button type="button" onclick="document.getElementById('wa_queue_delay_per_message').value=8" class="px-3 py-1.5 text-xs rounded-lg border border-orange-300 dark:border-orange-700 text-orange-700 dark:text-orange-400 hover:bg-orange-50 dark:hover:bg-orange-900/20 transition-colors">Aman (8s)</button>
                                <button type="button" onclick="document.getElementById('wa_queue_delay_per_message').value=15" class="px-3 py-1.5 text-xs rounded-lg border border-red-300 dark:border-red-700 text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors">Lambat (15s)</button>
                            </div>
                        </div>
    ...
    <script>
        ...
        // ===== Delay quick-set buttons =====
        function setDelay(seconds) {
            document.getElementById('wa_broadcast_delay').value = seconds;
        }
    </script>
    @endpush
</x-app-layout>
