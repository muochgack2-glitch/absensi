    ...
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto custom-scrollbar">
            ...
            >
                ...
                {{-- Badge: Alpha hari ini --}}
                @php $todayAlphaCount = \App\Models\AttendanceRecord::today()->where('status','alpha')->count(); @endphp
                @if($todayAlphaCount > 0)
                    <span class="sidebar-badge">{{ $todayAlphaCount }}</span>
                @endif
            </a>
            ...
            >
                ...
                @if($pendingIzin > 0)
                    <span class="sidebar-badge" id="notifBadgeNav">{{ $pendingIzin }}</span>
                @else
            ...
            <!-- Pengguna -->
            <a 
                href="{{ route('attendance.users.index') }}"
                class="sidebar-menu-item {{ request()->routeIs('attendance.users*') ? 'active' : '' }}"
                data-bs-toggle="tooltip" 
                data-bs-placement="right" 
                title="Pengguna"
            >
            ...
            <div class="sidebar-submenu-group" data-submenu="whatsapp">
                <button 
                    type="button"
                    class="sidebar-menu-item sidebar-submenu-toggle w-full {{ $waOpen ? 'submenu-active' : '' }}"
                ...
                <div class="sidebar-submenu {{ $waOpen ? 'submenu-open' : '' }}" id="submenu-whatsapp">
                    <a href="{{ route('whatsapp.index') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('whatsapp.index') ? 'active' : '' }}">
                        <i class="fas fa-tachometer-alt"></i>
                        <span class="nav-text">Dashboard</span>
                    </a>
                    <a href="{{ route('whatsapp.send') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('whatsapp.send') ? 'active' : '' }}">
                        <i class="fas fa-paper-plane"></i>
                        <span class="nav-text">Kirim Pesan</span>
                    </a>
                    <a href="{{ route('whatsapp.logs') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('whatsapp.logs') ? 'active' : '' }}">
                        <i class="fas fa-history"></i>
                        <span class="nav-text">Log Pesan</span>
                    </a>
                    <a href="{{ route('whatsapp.templates') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('whatsapp.templates*') ? 'active' : '' }}">
                        <i class="fas fa-file-alt"></i>
                        <span class="nav-text">Templates</span>
                    </a>
                    <a href="{{ route('whatsapp.broadcast') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('whatsapp.broadcast') ? 'active' : '' }}">
                        <i class="fas fa-bullhorn"></i>
                        <span class="nav-text">Broadcast</span>
                    </a>
                    <a href="{{ route('gateway.index') }}"
                       class="sidebar-submenu-item {{ request()->routeIs('gateway.*') ? 'active' : '' }}">
